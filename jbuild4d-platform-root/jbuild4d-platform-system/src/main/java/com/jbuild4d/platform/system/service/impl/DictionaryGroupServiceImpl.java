...
import com.jbuild4d.base.dbaccess.dao.systemsetting.DictionaryGroupMapper;
...
public class DictionaryGroupServiceImpl extends BaseServiceImpl<DictionaryGroupEntity> implements IDictionaryGroupService {
    ...
    @Override
    public int saveSimple(JB4DSession jb4DSession, String id, DictionaryGroupEntity record) throws JBuild4DGenerallyException {
        //判定是否存在同Value的记录
