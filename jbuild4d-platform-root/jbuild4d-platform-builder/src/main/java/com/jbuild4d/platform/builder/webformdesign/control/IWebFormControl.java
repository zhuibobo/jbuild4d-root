...
public interface IWebFormControl {
    void resolve(JB4DSession jb4DSession, FormResourceEntity record, Document doc, Element singleControlElem, HtmlControlDefinitionVo htmlControlPluginDefinitionVo);
