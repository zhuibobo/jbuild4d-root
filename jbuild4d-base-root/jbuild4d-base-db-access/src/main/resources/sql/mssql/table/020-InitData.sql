...
-----------------------------------------初始化文件夹-----------------------------------------
INSERT INTO
  TSYS_MENU (MENU_ID, MENU_NAME, MENU_TEXT, MENU_VALUE, MENU_TYPE, IS_EXPAND, IS_SYSTEM, LEFT_URL, RIGHT_URL, ORDER_NUM, ORGAN_ID, PARENT_ID, PARENT_ID_LIST, ICON_CLASS_NAME, CHILD_COUNT)
...
INSERT INTO
  TSYS_MENU (MENU_ID, MENU_NAME, MENU_TEXT, MENU_VALUE, MENU_TYPE, IS_EXPAND, IS_SYSTEM, LEFT_URL, RIGHT_URL, ORDER_NUM, ORGAN_ID, PARENT_ID, PARENT_ID_LIST, ICON_CLASS_NAME, CHILD_COUNT)
VALUES (200101, '开发样例', '开发样例', '开发样例', 'GroupTopMenu', '1', '1', '/PlatForm/devdemo/Menus.do', '', 41, '0', '0', '-1*0*200000', 'frame-top-menu-data', 1)

INSERT INTO
  TSYS_MENU (MENU_ID, MENU_NAME, MENU_TEXT, MENU_VALUE, MENU_TYPE, IS_EXPAND, IS_SYSTEM, LEFT_URL, RIGHT_URL, ORDER_NUM, ORGAN_ID, PARENT_ID, PARENT_ID_LIST, ICON_CLASS_NAME, CHILD_COUNT)
VALUES (200100, '数据字典分组', '数据字典分组', '数据字典分组', 'Group', '1', '1', '', '/PlatForm/System/DictionaryGroup/List.do', 51, '0', '200000', '-1*0*200000*200100', '', 1)

INSERT INTO
  TSYS_MENU (MENU_ID, MENU_NAME, MENU_TEXT, MENU_VALUE, MENU_TYPE, IS_EXPAND, IS_SYSTEM, LEFT_URL, RIGHT_URL, ORDER_NUM, ORGAN_ID, PARENT_ID, PARENT_ID_LIST, ICON_CLASS_NAME, CHILD_COUNT)
VALUES (200110, '数据字典', '数据字典', '数据字典', 'Group', '1', '1', '', '/PlatForm/System/Dictionary/List.do', 52, '0', '200000', '-1*0*200000*200110', '', 1)
