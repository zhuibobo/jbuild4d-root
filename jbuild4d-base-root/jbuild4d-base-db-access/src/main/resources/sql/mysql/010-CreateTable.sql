...
DROP TABLE IF EXISTS `TB4D_TEMPLATE_RESOURCE`;
CREATE TABLE `TB4D_TEMPLATE_RESOURCE` (
  `TEMPLATE_ID`             NVARCHAR(100)  NOT NULL,
  `TEMPLATE_NAME`           NVARCHAR(200)  NOT NULL,
  `TEMPLATE_CREATE_TIME`    DATETIME       NULL,
  `TEMPLATE_CREATER`        NVARCHAR(100)  NULL,
  `TEMPLATE_UPDATE_TIME`    DATETIME       NULL,
  `TEMPLATE_UPDATER`        NVARCHAR(100)  NULL,
  `TEMPLATE_TYPE`           NVARCHAR(100)  NULL,
  `TEMPLATE_ISSYSTEM`       NVARCHAR(10)   NULL,
  `TEMPLATE_ORDER_NUM`      INT            NULL,
  `TEMPLATE_DESC`           NVARCHAR(1000) NULL,
  `TEMPLATE_MODULE_ID`      NVARCHAR(100)  NOT NULL,
  `TEMPLATE_STATUS`         NVARCHAR(10)   NULL,
  `TEMPLATE_ORGAN_ID`       NVARCHAR(100)  NULL,
  `TEMPLATE_ORGAN_NAME`     NVARCHAR(100)  NULL,
  `TEMPLATE_IS_TEMPLATE`    NVARCHAR(100)  NULL,
  `TEMPLATE_IS_RESOLVE`     MEDIUMTEXT     NULL COMMENT '是否进行了解析',
  `TEMPLATE_HTML_SOURCE` MEDIUMTEXT     NULL COMMENT '原始的HTML',
  `TEMPLATE_HTML_RESOLVE` MEDIUMTEXT     NULL COMMENT '解析后的HTML',
  `TEMPLATE_JS_CONTENT`     MEDIUMTEXT     NULL,
  `TEMPLATE_CSS_CONTENT`    MEDIUMTEXT     NULL,
  `TEMPLATE_CONFIG_CONTENT` MEDIUMTEXT     NULL,
  `TEMPLATE_CONTENT_URL`    NVARCHAR(1000)  NULL,
  PRIMARY KEY (`TEMPLATE_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='应用设计-模版设计';
