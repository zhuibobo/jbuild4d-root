...
CREATE TABLE `TB4D_MODULE_GROUP` (
  `MODULE_GROUP_ID`          NVARCHAR(100)  NOT NULL,
  `MODULE_GROUP_VALUE`       NVARCHAR(200)  NOT NULL,
  `MODULE_GROUP_TEXT`        NVARCHAR(200)  NOT NULL,
  `MODULE_GROUP_ORDER_NUM`   INT           NULL,
  `MODULE_GROUP_CREATE_TIME` DATETIME       NULL,
  `MODULE_GROUP_DESC`        NVARCHAR(500)  NULL,
  `MODULE_GROUP_STATUS`      NVARCHAR(10)   NULL,
  `MODULE_GROUP_PARENT_ID`   NVARCHAR(100)  NULL,
  `MODULE_GROUP_ISSYSTEM`    NVARCHAR(10)   NULL,
  `MODULE_GROUP_DEL_ENABLE`  NVARCHAR(10)   NULL,
  `MODULE_GROUP_PID_LIST`    NVARCHAR(1200) NOT NULL,
  `MODULE_GROUP_CHILD_COUNT` INT           NULL,
  `MODULE_GROUP_ORGAN_ID`    NVARCHAR(100)  NULL,
  `MODULE_GROUP_ORGAN_NAME`  NVARCHAR(100)  NULL,
