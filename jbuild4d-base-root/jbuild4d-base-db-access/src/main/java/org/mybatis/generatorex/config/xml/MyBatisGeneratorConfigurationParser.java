 ...
 *  limitations under the License.
 */
package org.mybatis.generatorex.config.xml;

import static org.mybatis.generatorex.internal.util.StringUtility.isTrue;
...
import org.mybatis.generatorex.config.ColumnOverride;
import org.mybatis.generatorex.config.ColumnRenamingRule;
import org.mybatis.generatorex.config.CommentGeneratorConfiguration;
import org.mybatis.generatorex.config.Configuration;
import org.mybatis.generatorex.config.ConnectionFactoryConfiguration;
import org.mybatis.generatorex.config.Context;
import org.mybatis.generatorex.config.DomainObjectRenamingRule;
import org.mybatis.generatorex.config.GeneratedKey;
import org.mybatis.generatorex.config.IgnoredColumn;
import org.mybatis.generatorex.config.IgnoredColumnException;
import org.mybatis.generatorex.config.IgnoredColumnPattern;
import org.mybatis.generatorex.config.JDBCConnectionConfiguration;
import org.mybatis.generatorex.config.JavaClientGeneratorConfiguration;
import org.mybatis.generatorex.config.JavaModelGeneratorConfiguration;
import org.mybatis.generatorex.config.JavaTypeResolverConfiguration;
import org.mybatis.generatorex.config.ModelType;
import org.mybatis.generatorex.config.PluginConfiguration;
import org.mybatis.generatorex.config.PropertyHolder;
import org.mybatis.generatorex.config.SqlMapGeneratorConfiguration;
