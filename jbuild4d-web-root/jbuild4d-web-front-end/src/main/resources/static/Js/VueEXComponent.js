...
Vue.component("fd-control-select-bind-to-single-field-dialog", {
  ...
  methods: {
    ...
    resetFieldToSelectedStatus: function resetFieldToSelectedStatus() {
