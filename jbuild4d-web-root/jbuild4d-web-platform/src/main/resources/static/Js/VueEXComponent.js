  ...
  data: function data() {
    return {
      acInterface: {
        ...
        reloadData: "/PlatForm/Builder/List/GetListData",
        delete: "/PlatForm/Builder/List/Delete",
        move: "/PlatForm/Builder/List/Move"
      },
      idFieldName: "formId",
      searchCondition: {
        formModuleId: {
