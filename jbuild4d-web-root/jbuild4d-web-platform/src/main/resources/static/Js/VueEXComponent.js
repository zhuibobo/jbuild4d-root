...
Vue.component("table-relation-content-comp", {
  ...
  methods: {
    ...
    selectedTable: function selectedTable(tableData) {
    ...
    getFormatJson: function getFormatJson() {
      return this.formatJson;
    },
    setFormatJson: function setFormatJson(json) {
      var json = {
        tableList: [{
