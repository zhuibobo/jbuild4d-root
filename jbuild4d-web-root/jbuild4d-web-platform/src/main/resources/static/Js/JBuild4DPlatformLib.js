...
var BaseUtility = {
  ...
  BuildFrameView: function BuildFrameView(action, para) {
    if (StringUtility.EndWith(action, "View")) {
      var urlPara = "";
