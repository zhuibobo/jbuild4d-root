    ...
    CKEDITOR.plugins.add(CKEditorPluginUtility.Plugins[pluginName].Setting.SingleName, {
        init: function(editor) {
            ...
            function addToEditor(ckEditor, pluginSetting, props, contentWindow){
                ...
                CKEditorPluginUtility.BuildGeneralElemToCKWysiwyg("<div class=\"wysiwyg-wldct-list-simple-search-outer-wrap\">"+tip+"<div class=\"wysiwyg-wldct-list-simple-search-inner-wrap\"></div></div>", pluginSetting, props, contentWindow);
            }
            //注册常规插件的操作
